...
const faqData = [
  {
    ...
    answer: "Students who have completed 10+2 with Physics, Chemistry and Biology (PCB) from a recognised board are eligible to apply."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer: "Graduates can work as registered nurses, ICU nurses, community health nurses, healthcare coordinators, educators and more across hospitals, NGOs and government programs."
  },
  {
    id: 4,
    question: "Is practical training included in the program?",
    answer: "Yes — clinical demonstrations, hospital postings, simulation labs and community visits are an integral part of the curriculum."
  },
  {
    id: 5,
    question: "Can I pursue higher studies after B.Sc Nursing?",
    answer: "Absolutely. Graduates can pursue M.Sc Nursing, specialised certifications and research opportunities in India and abroad."
  },
  {
    id: 6,
    question: "Why choose Shri Ram College of Nursing?",
    answer: "26+ years of educational legacy, clinical exposure with leading hospitals, modern facilities and a strong student-centric approach."
  },
  {
    id: 7,
    question: "Is Dehradun a good city for nursing education?",
    answer: "Dehradun is one of India's leading education hubs with a peaceful environment, top hospitals and excellent connectivity to North India."
  }
];
const FAQ = () => {
 ...
 <h2 className=" text-[28px] md:text-[36px] leading-[45px] font-extrabold text-[#1C1917] Montserrat-font tracking-[-1px]">
        ...
        <p className="text-[#57534D] text-[14px] sm:text-[16px] max-w-2xl mx-auto leading-relaxed mb-12 px-2">
          Find immediate answers regarding eligibility criteria, clinical rotations, secure hostel facilities, and global license exams.
        </p>
