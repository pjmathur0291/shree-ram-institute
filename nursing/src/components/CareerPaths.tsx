      ...
      <div className="max-w-[1320px] mx-auto"> 
        <div className="text-center mb-12"> 
          ...
          <p className="text-[#000] text-[16px] max-w-3xl mx-auto leading-relaxed font-normal">
            India's healthcare system is expanding rapidly. A B.Sc Nursing opens doors across hospitals, 
            government services, armed forces, and international healthcare markets.
          </p>
        </div> 
        <motion.div 
          ...
          {metricsData.map((metric, idx) => (
            ...
            >  
              ...
              <div className="flex items-center gap-2 border-t border-[#F5F5F4] pt-3"> 
                ...
                <span className="text-[#000] font-bold text-[12px]">
                  {metric.label}
                </span>
              </div>
            </motion.div>
            ...
            > 
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-[#000] text-[12.5px] leading-relaxed font-light line-clamp-3">
                    {track.desc}
                  </p>
                </div>
